...
public class MJpegView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void play() {
        ...
        if (mMJpegViewThread != null) {
            Log.d(TAG, "play: mMJpegViewThread != null");
            stopPlay();
        }
        ...
        if(mMJpegInputStream != null) {
            ...
            Log.d(TAG, "play: mMJpegInputStream != null");
        }
    }
    ...
    private class MJpegViewThread extends Thread {
        ...
        private Rect getImageRect(int bitmapWidth, int bitmapHeight) {
            ...
            Log.d(TAG, "getImageRect: bitmap size "+mDisplayWidth+"  "+bitmapHeight);
